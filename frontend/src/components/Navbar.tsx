      ...
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <button
            ...
            className="hidden sm:flex items-center justify-center p-2 rounded-full hover:bg-white/10 text-gray-300 hover:text-white transition-colors border border-transparent hover:border-white/10"
          ...
          <button 
            ...
            className={cn(
              "flex hidden items-center gap-2 px-4 py-2 rounded-full font-medium transition-all duration-300 active:scale-95",
              walletAddress 
          ...
          >
            <Wallet className="w-4 h-4 hidden" />
