      ...
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl dark:shadow-2xl border border-gray-100 dark:border-gray-700">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleLogin}>
          ...
          <div>
            <button
              type="submit"
              className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-xl text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200 shadow-md hover:shadow-lg"
            >
              Sign in
            </button>
          </div>
        ...
        <div className="mt-6 flex justify-center">
          <Link href="/about" className="text-sm font-medium text-green-600 hover:text-green-500">
            Learn more about EcoAnalyzer
          </Link>
        </div>
      </div>
    </div>
